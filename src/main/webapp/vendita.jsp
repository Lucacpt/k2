<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" import="model.UserBean, java.util.regex.Pattern, java.util.regex.Matcher"%>
<%
...
<head>
    ...
    <script>
        function validaForm() {
            ...
            if (nome == "" || prezzo == "" || spedizione == "" || immagine == "" || tipologia == "" || tag == "" || descrizione == "") {
                alert("Tutti i campi devono essere compilati");
                return false;
            }

       
            if (!validaFormatoPrezzo(prezzo)) {
                alert("Il prezzo deve essere un numero valido con massimo due decimali");
                return false;
            }

       
            if (!validaFormatoSpedizione(spedizione)) {
                alert("Le spese di spedizione devono essere un numero valido con massimo due decimali");
                return false;
            }
        ...
        function validaFormatoPrezzo(prezzo) {
            var pattern = /^\d+(\.\d{1,2})?$/;
            return pattern.test(prezzo);
        }


        function validaFormatoSpedizione(spedizione) {
            var pattern = /^\d+(\.\d{1,2})?$/;
            return pattern.test(spedizione);
        }
    </script>
</head>
<body>
...
<div class="test">
    <div class="container" style="height: 540px">
        ...
        <div class="content">
            <form action="Vendita" enctype="multipart/form-data" METHOD="POST" onsubmit="return validaForm()">
                <div class="user-details">
                    ...
                    <div class="input-box">
                        ...
                        <input type="number" id="prezzo" name="prezzo" step="0.01" max="9999999" placeholder="Inserire prezzo" required/>
                    </div>
                    <div class="input-box">
                        <span class="details">Spese di spedizione</span>
                        <input type="number" id="spedizione" name="spedizione" step="0.01" max="999" placeholder="Inserire spese di spedizione" required/>
                    </div>
                    <div class="input-box">
